...
contract Cheq is ERC721, Ownable {
    ...
    event Void(address indexed drawer, address indexed auditor, uint256 indexed tokenId);
    event DirectTransfer(IERC20 indexed _token, address indexed to, uint256 _amount);
