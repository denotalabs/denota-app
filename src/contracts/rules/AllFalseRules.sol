...
contract AllFalseRules is IWriteRule, ITransferRule, IFundRule, ICashRule, IApproveRule { // Each rule the module uses can use different contracts or the point to the same ones
    function canWrite(address /*caller*/, address /*owner*/, uint256 /*cheqId*/, DataTypes.Cheq calldata /*cheq*/, bytes calldata /*initData*/) external pure { revert("WriteRule: Disallowed"); }
    ...
    function canFund(address /*caller*/, address /*owner*/, uint256 /*amount*/, uint256 /*cheqId*/,  DataTypes.Cheq calldata /*cheq*/,  bytes calldata /*initData*/) external pure { revert("FunRule: Disallowed"); }
