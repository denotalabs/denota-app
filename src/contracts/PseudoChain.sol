...
contract PseudoChain is ICheqModule, Ownable, ERC721 {  
    ...
    function fundable(uint256 /* cheqId */, address /* caller */, uint256 /* amount */) public pure returns(uint256) {
        return 0;
    }
    ...
    function cashable(uint256 cheqId, address /* caller */, uint256 /* amount */) public view returns(uint256) {
