...
contract RegistrarFees is Ownable {
    ...
    mapping(address => mapping(address=>uint256)) internal _moduleTokenRevenue;
    ...
    function getFees() internal view returns(uint256, uint256, uint256, uint256, uint256, uint256){
        return (_writeFlatFee, _writeBPSFee, _transferBPSFee, _fundFlatFee, _fundBPSFee, _cashFlatFee);
    }
}