...
export class CheqRegistrar extends ethereum.SmartContract {
  ...
  cheqAmount(cheqId: BigInt): BigInt {
    let result = super.call("cheqAmount", "cheqAmount(uint256):(uint256)", [
  ...
  try_cheqAmount(cheqId: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("cheqAmount", "cheqAmount(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(cheqId)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  cheqDrawer(cheqId: BigInt): Address {
    let result = super.call("cheqDrawer", "cheqDrawer(uint256):(address)", [
      ethereum.Value.fromUnsignedBigInt(cheqId)
    ]);
  ...
  try_cheqDrawer(cheqId: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall("cheqDrawer", "cheqDrawer(uint256):(address)", [
      ethereum.Value.fromUnsignedBigInt(cheqId)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  cheqEscrowed(cheqId: BigInt): BigInt {
    let result = super.call("cheqEscrowed", "cheqEscrowed(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(cheqId)
    ]);
  ...
  cheqModule(cheqId: BigInt): Address {
    let result = super.call("cheqModule", "cheqModule(uint256):(address)", [
      ethereum.Value.fromUnsignedBigInt(cheqId)
    ]);
  ...
  try_cheqModule(cheqId: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall("cheqModule", "cheqModule(uint256):(address)", [
      ethereum.Value.fromUnsignedBigInt(cheqId)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  cheqToken(cheqId: BigInt): Address {
    let result = super.call("cheqToken", "cheqToken(uint256):(address)", [
      ethereum.Value.fromUnsignedBigInt(cheqId)
    ]);
  ...
  try_cheqToken(cheqId: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall("cheqToken", "cheqToken(uint256):(address)", [
      ethereum.Value.fromUnsignedBigInt(cheqId)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  deposit(_token: Address, _amount: BigInt): boolean {
    let result = super.call("deposit", "deposit(address,uint256):(bool)", [
  ...
  try_deposit(_token: Address, _amount: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall("deposit", "deposit(address,uint256):(bool)", [
      ethereum.Value.fromAddress(_token),
      ethereum.Value.fromUnsignedBigInt(_amount)
    ]);
    if (result.reverted) {
