...
export class Account extends Entity {
  constructor(id: string) {
    ...
    this.set("numCheqsOwned", Value.fromBigInt(BigInt.zero()));
    this.set("numCheqsSent", Value.fromBigInt(BigInt.zero()));
    this.set("numCheqsReceived", Value.fromBigInt(BigInt.zero()));
  }
  ...
  get numCheqsOwned(): BigInt {
    let value = this.get("numCheqsOwned");
    return value!.toBigInt();
  }

  set numCheqsOwned(value: BigInt) {
    this.set("numCheqsOwned", Value.fromBigInt(value));
  }
  ...
  get numCheqsSent(): BigInt {
    let value = this.get("numCheqsSent");
    return value!.toBigInt();
  }

  set numCheqsSent(value: BigInt) {
    this.set("numCheqsSent", Value.fromBigInt(value));
  }
  ...
  get numCheqsReceived(): BigInt {
    let value = this.get("numCheqsReceived");
    return value!.toBigInt();
  }

  set numCheqsReceived(value: BigInt) {
    this.set("numCheqsReceived", Value.fromBigInt(value));
  }
...
export class Cheq extends Entity {
  ...
  set moduleData(value: string | null) {
    if (!value) {
      this.unset("moduleData");
    } else {
      this.set("moduleData", Value.fromString(<string>value));
    }
  }
