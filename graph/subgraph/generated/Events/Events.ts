...
export class RuleWhitelisted extends ethereum.Event {
  get params(): RuleWhitelisted__Params {
    return new RuleWhitelisted__Params(this);
  }
}

export class RuleWhitelisted__Params {
  _event: RuleWhitelisted;

  constructor(event: RuleWhitelisted) {
    this._event = event;
  }
